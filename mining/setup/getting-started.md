...
# 7. [Configure Your Node](configuration.md)

Depending on your node type, operating phase, and different elements of your hardware and system configuration you will want to run your node with a different set of configuration options. The [Configuring Your Node](configuration.md) guide describes how to set them.

# 8. [Run Your Node](running.md)

Launch your node and work through the operating phases for your node type. We've provided a few examples in the [Running Your Node](running.md) guide to get you started.
